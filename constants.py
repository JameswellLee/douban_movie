...
# 代理隧道验证信息
proxyUser = "H5046760O3XM1G0P"
proxyPass = "B604221CEB0A8AB8"
...
# 代理服务器
proxyHost2 = "http-pro.abuyun.com"
proxyPort2 = "9010"

# 代理隧道验证信息
proxyUser2 = "H5046760O3XM1G0P"
proxyPass2 = "B604221CEB0A8AB8"

proxyMeta2 = "http://%(user)s:%(pass)s@%(host)s:%(port)s" % {
    "host" : proxyHost2,
    "port" : proxyPort2,
    "user" : proxyUser2,
    "pass" : proxyPass2,
